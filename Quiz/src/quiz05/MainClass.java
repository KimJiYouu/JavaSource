...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		cal.sub(5);
		System.out.println(cal.result);
		double cir = cal.circle(5);
		System.out.println("원의 넓이: "+cir);

		
		Computer com = new Computer();
		double cir2 = com.circle(5);
		System.out.println("원의 넓이: "+cir2);
		
		double re = com.rect(5);
		System.out.println("정사각형의 넓이: "+re);
		
		double re2 = com.rect(5,6);
		System.out.println("직사각형의 넓이: "+re2);
		
		double re3 = com.rect(5,6,7);
		System.out.println("직육면체의 겉넓이: "+re3);
