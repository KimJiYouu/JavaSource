...
public class PageClass extends User {
	...
	public void showShopPage() {
		...
		System.out.print("-----------------------------------------------");
		System.out.println("");
		List<ShoppingMallVO>  ss = da.getShoppingMallItem();
		for(int i = 0; i <ss.size(); i++) {
			int itemNum = ss.get(i).getItemNum();
			String itemBrand = ss.get(i).getItemBrand();
			String itemName = ss.get(i).getItemName();
			int itemPoint = ss.get(i).getItemPoint();
