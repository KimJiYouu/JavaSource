...
public class Training extends User implements Color {
	...
	public void TodayTraining() {
		...
		WorkOutListVO s = gdao.getTodayWorkOut(num).get(0);
		
		this.workOut_Name = s.getWorkOut_name();
		this.workOut_Reps = s.getWorkOut_reps();
		this.workOut_Link = s.getWorkOut_link();
